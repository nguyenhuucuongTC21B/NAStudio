...
(function () {
  ...
  const state = {
    ...
    cloudProviders: [],       // bảng dịch vụ online + trạng thái (12 từ FIX56 — gỡ Smrfhdl)
  ...
  const actions = {
    ...
    async hydrate() {
      ...
      if (settings) {
        ...
        // PATCH FIX53: giọng online đã lưu
        state.cloudVoice = settings.cloudVoice || "";
      }
