...
(function () {
  ...
  const ICONS = {
    ...
    // PATCH FIX53: chế độ online — cloud, máy, file văn bản, làm mới
    cloud:    S(`<path d="M7 18.5a4.5 4.5 0 01-.6-8.96 5.5 5.5 0 0110.7-1.2A4 4 0 0117 18.5z" ${st}/>`, 'fill="none" stroke="currentColor"'),
    desktop:  S(`<rect x="3" y="4.5" width="18" height="12.5" rx="2"/><path d="M9 20.5h6M12 17v3.5" ${st}/>`, 'fill="none" stroke="currentColor"'),
    filetext: S(`<path d="M6.5 3.5h7L18 8v12.5h-11.5zM13.5 3.5V8H18M9 12h6M9 15.5h6" ${st}/>`, 'fill="none" stroke="currentColor"'),
    refresh:  S(`<path d="M20 12a8 8 0 11-2.34-5.66M20 4.5V10h-5.5" ${st}/>`, 'fill="none" stroke="currentColor"'),
  };
